...
import { useUser } from "@/lib/user-provider" // Agora importamos diretamente do provider
...
// Mantemos a função useWatchlist aqui também para compatibilidade
